...
public class LevelManagerEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (GUILayout.Button("Delete Saves", GUILayout.Width(200), GUILayout.Height(20)))
		{
			...
			if (File.Exists(Path.Combine(Application.dataPath, @"Game\WorkingData\Editor\SavesEditorYG.json"))) File.Delete(Path.Combine(Application.dataPath, @"Game\WorkingData\Editor\SavesEditorYG.json"));
		}
	}
